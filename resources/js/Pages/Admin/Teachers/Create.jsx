            ...
            <Card>
                    ...
                    <form onSubmit={onHandleSubmit}>
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-4">
                            <div className="col-span-full">
                                <Label htmlFor="name">Nama Dosen dan Gelar :</Label>
                                <Input
                                    type="text"
                                    name="name"
                                    id="name"
              ...
              <div className="col-span-full">
                ...
                {errors.fee_group_id && <InputError message={errors.fee_group_id} />}
                            ...
                            <div className="col-span-2">
                                <Label htmlFor="teacher_number">NIDN :</Label>
                                <Input
                                    type="text"
                                    name="teacher_number"
                                    id="teacher_number"
                ...
                {errors.semester && <InputError message={errors.semester} />}
                            ...
                            <div className="col-span-2">
                                <Label htmlFor="academic_title">Jabatan Academik</Label>
                                <Input
                                    type="text"
                                    name="academic_title"
                                    id="academic_title"
                                    ...
                                    onChange={onHandleChange}
                                    placeholder="Masukkan Jabatan Academik"
                                />
