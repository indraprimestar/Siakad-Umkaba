...
import { deleteAction, formatDateIndo, formatRupiah } from '@/lib/utils';
                ...
                <CardContent className="p-0 [&-td]:whitespace-nowrap [&-td]:px-6 [&-th]:py-6">
                    {feeGroups.length == 0 ? (
                        <EmptyState
                            ...
                            subctitle="Mulailah atau Silahkan tambahkan data golongan UKT baru"
                        />
                    ) : (
                            ...
                            <TableBody>
                                {feeGroups.map((feeGroup, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>{formatRupiah(feeGroup.amount)}</TableCell>
