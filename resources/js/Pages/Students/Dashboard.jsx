...
export default function Dashboard(props) {
    return (
        <div className="flex flex-col gap-8">
            <div className="justify-beetwen flex flex-col items-center gap-y-4 lg:flex-row">
                <div>
            ...
            <div className="mb-8 grid gap-4 lg:grid-cols-3">
                ...
                >
                    <div className="text-2xl font-bold">{formatRupiah(props.count.total_payments)}</div>
                </CardStat>
            </div>
        </div>
    );
