...
import { IconCalendar, IconDoor, IconLayout2 } from '@tabler/icons-react';
    ...
    return (
        <div className="flex w-full flex-col pb-32">
            ...
            <div className="mb-8 flex flex-col">
                <h2 className="text-xl font-medium leading-relaxed text-foreground">Assalamualaikum, {auth.name}</h2>
                <p className="text-sm text-muted-foreground">Selamat Datang di Sistem Informasi Akademik UMKABA</p>
            </div>
