...
Route::prefix('operators')->middleware(['auth', 'role:Admin Fakultas'])->group(function () {
    ...
    Route::controller(StudyPlanOperatorController::class)->group(function() {
        Route::get('student/{student:student_number}/study-plans', 'index')->name('operators.study-plans.index');
        Route::put('student/{student:student_number}/study-plans/{studyPlan}/approve', 'approve')->name('operators.study-plans.approve');
    });
