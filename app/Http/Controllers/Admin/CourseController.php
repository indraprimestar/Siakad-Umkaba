...
class CourseController extends Controller implements HasMiddleware
{
    ...
    public function index(): Response
    {
        ...
        return inertia('Admin/Courses/Index', [
            'page_settings' => [
                'title' => 'Mata Kuliah',
                'subtitle' => 'Menampilkan Semua data mata kuliah yang ada di UMKABA',
            ],
    ...
    public function create(): Response
    {
        return inertia('Admin/Courses/Create', [
            'page_settings' => [
                ...
                'subtitle' => 'Buat mata kuliah baru disini. klik simpan untuk menyimpan data.',
                'method' => 'POST',
            ...
            'teachers' => Teacher::query()
                ...
                ->whereHas('user', function ($query) {
                    $query->whereHas('roles', fn($query) => $query->where('name', 'Dosen'))->orderBy('name');
                })
                ->get()
                ->map(fn($item) =>[
                    'value' => $item->id,
